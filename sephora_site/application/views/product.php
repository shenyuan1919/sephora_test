...
<article class="grid-container">
	...
	<div class="grid-x grid-padding-x">
			...
			<div class="grid-x grid-padding-x">
				...
				<div class="medium-12 small-6 cell">
					...
					<ul class="vertical menu">
						...
						<li>
							<input type="radio" class="priceRange" name="priceRange" value="10000_max" id="10000_max" onchange="searchFilter()" />
							<label class="choice" for="10000_max"> Above $100</label><br />
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="medium-9 small-12 cell">
			<div class="grid-x grid-padding-x" >
				<div class="large-9 medium-8 small-2 cell">
